...
> Открыть эту страницу в [https://stanislav-pugachev.github.io/-/](https://stanislav-pugachev.github.io/-/)
...
* найдите **https://github.com/stanislav-pugachev/-** и импортируйте

## Править этот проект ![Значок статуса сборки](https://github.com/stanislav-pugachev/-/workflows/MakeCode/badge.svg)

Редактировать этот репозиторий в MakeCode.

* открыть [https://makecode.microbit.org/](https://makecode.microbit.org/)
* нажмите на **Импорт**, затем **Импорт URL**
* вставьте **https://github.com/stanislav-pugachev/-** и нажмите Импорт
...
![Отрисовка в виде блоков](https://github.com/stanislav-pugachev/-/raw/master/.github/makecode/blocks.png)
